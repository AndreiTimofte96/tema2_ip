...
int main()
{
	char ADN1[MAX_ADN], ADN2[MAX_ADN], ADN3[MAX_ADN];
	codificareADN(28, ADN1);//a
	cout<<ADN1<<'\n';
	cout<<decodificareADN(ADN1)<<'\n';//b

	codificareADN(1, ADN2);//a
	cout<<ADN2<<'\n';
	cout<<decodificareADN(ADN2)<<'\n';

	//adunareADN(ADN1, ADN2, ADN3);
	scadereADN(ADN1, ADN2, ADN3);
	cout<<ADN3<<'\n';
	return 0;
}
